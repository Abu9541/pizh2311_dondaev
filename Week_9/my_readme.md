...
*wordcount.exe до реализации принципа единственной ответственности SOLID:*  
```cpp
#include <iostream>
#include <fstream>
#include <string>
...
*wordcount.exe после реализации принципа единственной ответственности SOLID:*  
```cpp
#include <iostream>
#include <fstream>
#include <string>
...
```  
Для реализации принципа единственной ответственности, который гласит, что для изменения класса должна быть одна и только одна причина, были внедрены классы, которые разделили функционал программы на составные части. Каждый класс используется для реализации одного единственного функционала.  
Так, например, класс FilaStats используется для хранения данных, FileStatsCounter - для подсчета статистики файла, StatsPrinter - для вывода статистики, ArgumentParser - для обработки аргументов командной строки, а WordCountApplication - для координации работы приложения.
